<?php
    ...
    include_once("../db.php");
    $sqlAllProducts = "SELECT * FROM products P INNER JOIN category C ON P.cat_id = C.cat_id ORDER BY prd_id";
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center" id="product-img"><img width="90" height="120"
                                            src="img/<?php echo $product['prd_image']; ?>" /></td>
                                    <td><?php
                                    if ($product['prd_status'] == 1) {
                                        echo '<span class="label label-success">Stocking</span>';
                                    } else {
                                        echo '<span class="label label-success">Out of Stock</span>';
                                    }
                                    ?></td>
